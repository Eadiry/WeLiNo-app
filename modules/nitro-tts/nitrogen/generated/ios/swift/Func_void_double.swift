...
/**
 * Wraps a Swift `(_ remaining: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.nitrotts.bridge.swift

  private let closure: (_ remaining: Double) -> Void

  public init(_ closure: @escaping (_ remaining: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(remaining: Double) -> Void {
    self.closure(remaining)
  }
