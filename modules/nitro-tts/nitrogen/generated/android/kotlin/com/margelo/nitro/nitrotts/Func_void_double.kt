...
/**
 * Represents the JavaScript callback `(remaining: number) => void`.
...
fun interface Func_void_double: (Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(remaining: Double): Unit
}
...
class Func_void_double_cxx: Func_void_double {
  ...
  @Keep
  override fun invoke(remaining: Double): Unit
    = invoke_cxx(remaining)

  @FastNative
  private external fun invoke_cxx(remaining: Double): Unit
}
...
class Func_void_double_java(private val function: (Double) -> Unit): Func_void_double {
  ...
  @Keep
  override fun invoke(remaining: Double): Unit {
    return this.function(remaining)
  }
}
